...
public class OutsideOne implements Map {
    ...
    public static AutoPart[] floorPixelParts = {
            ...
            new AutoPart(PartType.SPLINE_TO, new Pose2d(-46, -28, Math.PI), RobotParams.intakeOffset, Math.PI),
    ...
    public static AutoPart[] backdropPixelParts = {
            new AutoPart(PartType.STRAFE_TO, new Pose2d(58, -29, Math.PI), RobotParams.liftOffset),
            new AutoPart(PartType.WAIT, 3),
